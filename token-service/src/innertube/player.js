...
import { sigMatcher, nMatcher, timestampMatcher } from '../js/matchers.js';
 ...
 */
async function fetchPlayerJs(playerId) {
 ...
 */
export async function decipherUrl(playerData, url, signatureCipher) {

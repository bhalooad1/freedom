 ...
 */
export function sigMatcher(node: ESTree.Node): ESTree.Node | false {
 ...
 */
export function nMatcher(node: ESTree.Node): ESTree.Node | false {
 ...
 */
export function timestampMatcher(node: ESTree.Node): ESTree.Node | false {
